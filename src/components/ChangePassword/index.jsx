    ...
    <>
      ...
      <section className="bg-[#FAFAFA] min-h-[calc(100vh-120px)] p-[26px_16px] flex flex-col max-md:min-h-[calc(100vh-68px)] max-[1300px]:min-h-[calc(100vh-79px)] max-[1300px]:p-[16px]">
        ...
        <div className="max-w-[394px] mx-auto mb-auto">
          <h1 className="text-[36px] font-semibold leading-[43px] text-[#1D1D1F] text-center mb-[17px] max-sm:text-[28px]">
            Set New Password
          </h1>
          <p className="text-base font-medium leading-[17px] text-[#83838D] text-center mb-[32px] max-[1300px]:mb-[16px]">
            Your new password must be different to previously passwords{" "}
          </p>
          <div className="bg-[#FFFFFF] border border-[#E9E9E9] p-[30px] rounded-[12px] max-w-[394px] mx-auto max-[1300px]:p-[16px]">
            <div className="mb-[24px] last-of-type:mb-0 max-[1300px]:mb-[16px]">
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  className={`border rounded-[4px] h-[42px] p-[6px_10px] text-black outline-none block w-full text-[14px] font-normal leading-[16px] placeholder:text-[#1516188F] ${
                    errorPasswordShow
                      ? "border-[#EC1919]"
                      : "border-[#00000029]"
                  } `}
            ...
            <Link
              href="#"
              className="bg-[#1D1D1F] border border-[#D8D8D8] text-[14px] leading-[16px] p-[12px] w-full block h-[42px] font-semibold text-[#FFFFFF] mt-[24px] rounded-[4px] text-center hover:bg-[#28282c]"
              onClick={handleClick}
            >
              Reset password
            </Link>
